...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React2 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef2 = React2.useRef, useEffect2 = React2.useEffect, useMemo2 = React2.useMemo, useDebugValue2 = React2.useDebugValue;
...
var PureEditorContent = class extends import_react.default.Component {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", {
      ...
      ...rest
    }), (editor === null || editor === void 0 ? void 0 : editor.contentComponent) && (0, import_jsx_runtime.jsx)(Portals, { contentComponent: editor.contentComponent })] });
  }
};
...
function EditorProvider({ children, slotAfter, slotBefore, editorContainerProps = {}, ...editorOptions }) {
  ...
  return (0, import_jsx_runtime.jsxs)(EditorContext.Provider, {
    value: contextValue,
    children: [
      slotBefore,
      (0, import_jsx_runtime.jsx)(EditorConsumer, { children: ({ editor: currentEditor }) => (0, import_jsx_runtime.jsx)(EditorContent, {
...
var ReactRenderer = class {
  ...
  */
  render() {
    ...
    this.reactElement = (0, import_jsx_runtime.jsx)(Component, { ...elementProps });
...
var ReactMarkViewContext = import_react.default.createContext({ markViewContentRef: () => {
} });
var MarkViewContent = (props) => {
  const { as: Tag = "span", ...rest } = props;
  const { markViewContentRef } = import_react.default.useContext(ReactMarkViewContext);
  return (0, import_jsx_runtime.jsx)(Tag, {
    ...rest,
...
var ReactMarkView = class extends MarkView {
  constructor(component, props, options) {
    ...
    const ReactMarkViewProvider = import_react.default.memo((componentProps2) => {
      return (0, import_jsx_runtime.jsx)(ReactMarkViewContext.Provider, {
        value: context,
        children: import_react.default.createElement(component, componentProps2)
      });
    });
...
var ReactNodeViewSelectionTracker = class {
  constructor(editor) {
    ...
    this.viewCount = 0;
    this.insideViews = /* @__PURE__ */ new Set();
    ...
    this.handleTransaction = () => this.scheduleSync();
    this.editor = editor;
  }
  register(view) {
    if (this.viewCount === 0) this.editor.on("transaction", this.handleTransaction);
  ...
  unregister(view) {
    ...
    if (this.viewCount === 0) this.editor.off("transaction", this.handleTransaction);
  }
  sync() {
  ...
  updateViews(views, unchangedViews, selectionInside) {
    for (const view of views) if (!unchangedViews.has(view)) view.setSelectionInside(selectionInside);
  }
  findInsideViews() {
    const insideViews = /* @__PURE__ */ new Set();
    for (const position of getTextSelectionAncestorPositions(this.editor.state.selection)) {
      ...
      const view = dom ? this.views.get(dom) : void 0;
      if (view) insideViews.add(view);
    }
    return insideViews;
  }
};
var trackers = /* @__PURE__ */ new WeakMap();
function getReactNodeViewSelectionTracker(editor) {
...
var ReactNodeView = class extends NodeView {
  ...
  */
  mount() {
    ...
    const ReactNodeViewProvider = (0, import_react.memo)((componentProps) => {
      return (0, import_jsx_runtime.jsx)(ReactNodeViewContext.Provider, {
        value: context,
  ...
  */
  deselectNode() {
    this.nodeSelected = false;
    this.updateSelectedState(this.options.selectedOnTextSelection === true && this.isTextSelectionInside());
  }
  setSelectionInside(selectionInside) {
  ...
  isTextSelectionInside() {
    ...
    return typeof pos === "number" && getTextSelectionAncestorPositions(this.editor.state.selection).includes(pos);
  }
  /**
...
var WIDGET_CACHE = Symbol("tiptapReactWidgetCache");
...
function TiptapWrapper({ children, ...props }) {
  ...
  return (0, import_jsx_runtime.jsx)(EditorContext.Provider, {
    value: legacyContextValue,
    children: (0, import_jsx_runtime.jsx)(TiptapContext.Provider, {
...
function TiptapContent({ ...rest }) {
  const { editor } = useTiptap();
  return (0, import_jsx_runtime.jsx)(EditorContent, {
    editor,
    ...rest
  });
}
